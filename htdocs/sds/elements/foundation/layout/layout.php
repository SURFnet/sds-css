...
<div class="grid-container">
  ...
  <div class="demo-bg col-md--span-4 col-lg--span-4">Breakpoint "md" - "lg", span 4 of 6 columns. Breakpoint "lg" and up, span 4 of 12 columns. Note that "sm" is not applied so it takes 1 out of 2 columns.</div>
</div>
